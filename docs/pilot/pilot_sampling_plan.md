...
| P5 (operational comparator) | CF-11 | DOC-ALT-FNSS-001 (FEMA FNSS 2010) | Function-based operational FNSS doctrine (OPT-B / PA-2026-07-31-002) | US | B |
| P5-CONCEPT | CF-02 | DOC-CF02-01 | Conceptual AFN / anti-deficit grounding only (fulltext NO_GO) | US-origin | B (non-coding) |
...
- [x] Benchmark comparator pathway (FNSS operational L1 adopted) — **execution still blocked** on independent coder
...
- **Phase B source:** PA-2026-07-31-002 → FNSS READY; CF-02 conceptual  
- **Complete pilot:** Phase A + Phase B execution → blocked while `BENCHMARK_CALIBRATION=NO_GO` (independent coder)  
